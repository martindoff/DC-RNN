...
def f1_grid(h1, h2, u, param):
    ...
    """
    return (param.k_p*u - param.A1*np.sqrt(2*param.g*h1))/param.A

def f2_grid(h1, h2, u, param):
    ...
    Output: f dynamics function
    """
    return (param.A1*np.sqrt(2*param.g*h1) - param.A2*np.sqrt(2*param.g*h2))/param.A
